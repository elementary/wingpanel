...
namespace Meta {
	...
	namespace Prefs {
        [CCode (cheader_filename = "meta/prefs.h", cname = "meta_prefs_add_listener")]
		public static void prefs_add_listener (Meta.PrefsChangedFunc func);
        ...
        [CCode (cheader_filename = "meta/prefs.h", cname = "meta_prefs_remove_listener")]
		public static void prefs_remove_listener (Meta.PrefsChangedFunc func);
