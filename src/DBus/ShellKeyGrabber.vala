...
public interface ShellKeyGrabber : GLib.Object {
    ...
    private static HashTable<uint, string> saved_action_ids;

    public static void init () {
        settings = new Settings ("io.elementary.panel.keybindings");
        saved_action_ids = new HashTable<uint, string> (null, null);
